...
# Generator
# The role of a generator is to take a random vector of some size and generate the target image. It is very similar to the generative side of autoencoder.
...
optimizer = keras.optimizers.legacy.Adam(lr=0.0002, decay=8e-9)

generator.compile(loss='binary_crossentropy',optimizer=optimizer,metrics=['accuracy'])

# Discriminator
# Discriminator is a classical image classification network.
...
optimizer = keras.optimizers.legacy.Adam(0.0001) #, 0.5)
